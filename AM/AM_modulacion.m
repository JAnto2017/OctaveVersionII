...
N = input( 'Numero de muestas:  ' )                  
fs = input('Frecuencia de muestreo:  ')             
fc = input('Frecuencia de la portadora:  ')                    
fm = input('Frecuencia de la moduladora (informacion):  ')      
Ec = input('Amplitud de la portadora:  ')                      
Em = input('Amplitud de la Moduladora (informacion):  ')     
t = (0:N-1)/fs;
